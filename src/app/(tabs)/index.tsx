...
export default function HomeScreen() {
  ...
  return (
    <Screen>
      ...
      {/* Guilt-free hero */}
      <Card background={t.candy.mint} style={{ marginBottom: t.spacing.lg }}>
      ...
      {/* Roast of the day */}
      <Card background={t.candy.yellow} style={{ marginBottom: t.spacing.lg }}>
        <AppText variant="label" color={t.candyText}>
          Roast of the day
        </AppText>
      ...
      <View style={{ flexDirection: 'row', gap: t.spacing.sm, marginBottom: t.spacing.lg, flexWrap: 'wrap' }}>
